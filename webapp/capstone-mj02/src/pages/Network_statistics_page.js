...
function Networkstatisticspage() {
    ...
    <div>
      ...
      {device === "router" && (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div>
            <select
            class="w-48 px-2 py-1 rounded-md text-gray-800 bg-gray-200 mt-5 ml-2"
              defaultValue=""
              onChange={(e) => setClientSelection(e.target.value)}
            >
              <option value="">Select an option</option>
              <option value="C8:C9:A3:6A:6D:70">
                Device 1 (C8:C9:A3:6A:6D:70)
              </option>
              <option value="D4:57:63:EC:D1:4C">
                Device 2 (D4:57:63:EC:D1:4C)
              </option>
  ...
  <div class="grid grid-cols-2 gap-6">
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <p class="text-gray-600 truncate">2.4 GHz</p>
      )}
    </div>
    <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <p class="text-gray-600 truncate">
          {ogNetworkDatas[ogNetworkDatas.length - 1]["devices"][            client_selection          ].authenticated === "yes"
            ? "True"
            : "False"}
        </p>
      )}
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <p class="text-gray-600 truncate">
          {ogNetworkDatas[ogNetworkDatas.length - 1]["devices"][            client_selection          ].authorized === "yes"
            ? "True"
            : ""}
        </p>
      )}
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <p class="text-gray-600 truncate">
          {ogNetworkDatas[ogNetworkDatas.length - 1]["devices"][            client_selection          ]["connected time"]}
        </p>
      )}
    </div>
  </div>
...
<div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <p class="text-gray-600 overflow-ellipsis whitespace-nowrap truncate ">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      {client_selection !== "" && (
        <ul class="text-gray-600">
          <li class="overflow-ellipsis whitespace-nowrap truncate">
            Device 1 (3C:61:05:D5:0A:9E): Connected
          </li>
          <li class="overflow-ellipsis whitespace-nowrap truncate">
            Device 2 (AC:12:03:D6:B6:0E): Connected
          </li>
          <li class="overflow-ellipsis whitespace-nowrap truncate">
            Device 2 (AC:12:03:D6:B6:0E): Connected
          </li>
      ...
      {device === "central" && ogNetworkDatas.length > 0&& (
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            {ogNetworkDatas[ogNetworkDatas.length - 1]["firebase_collector"] === true
              ? "Yes"
              : "No"}
          </p>
        </div>
