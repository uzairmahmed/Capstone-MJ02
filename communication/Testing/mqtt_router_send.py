...
mqttc.connect("10.0.103.158", 1883)  # Connect to (broker, port, keepalive-time)
...
for i in range(0,150):
    ...
    mqttc.publish("iOT_1/control", "connected-device")  # Publish message to “digitest /test1” topic
